...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { point: @point.point, shop_id: @point.shop_id, user_id: @point.user_id } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { point: @point.point, shop_id: @point.shop_id, user_id: @point.user_id } }
